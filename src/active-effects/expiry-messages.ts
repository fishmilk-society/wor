...
//  */
// export async function triggerExpiryFor(effect: StatusEffect): Promise<void>
// {
...
//     // await (effect as any).setFlag(MODULE, FLAG, unwrap(newMessage).id)
...
//  */
// export async function revertExpiryFor(effect: StatusEffect): Promise<void>
// {
...
//  */
// export function wasExpiryTriggeredFor(effect: StatusEffect): boolean
// {
//     return effect.expired// !!effect.getFlag(MODULE, FLAG)
// }
